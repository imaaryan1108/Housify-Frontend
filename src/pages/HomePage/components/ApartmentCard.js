  ...
  return (
    <div>
      <Card className={classes.card}>
        <CardMedia className={classes.media} image={apt} />
        <CardContent>
          <Typography variant="body2" color="textSecondary" component="p">
            <p className={classes.price}>50 Lakh </p>
            <p className={classes.name}>Veda 42 </p>
            <p className={classes.location}>VIP Road</p>
          </Typography>
        </CardContent>
      </Card>
    </div>
